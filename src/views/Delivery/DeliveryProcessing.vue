<template>
  ...
  <div class="l-container focus-out">
    ...
    <div class="delivery-processing">
      <div class="l-inner l-scroll">
        <div class="l-total">
          ...
          <div class="btn-group">
            <button class="btn btn-size-regular secondary">
              삭제
            </button>
            <button
    ...
    <div
      v-show="!deliveryNone"
      class="l-delivery-bottom processing"
    >
      <button class="btn btn-size-full btn-size-large white">
        대상 이관
      </button>
      <div class="btn-group-wrap">
        <div class="btn-group">
          <button class="btn btn-size-full btn-size-large">
            집하
          </button>
          <button class="btn btn-size-full btn-size-large">
            대량집하
    ...
    <!-- 집하인 경우 isPickup -->
    <div
      class="l-dialog l-delivery-detail"
      ...
      >
        ...
        <div class="content">
          ...
          <div class="card">
            ...
            <div class="btn-group">
              <button class="btn ft-size-xsmall">
                배송
              </button>
              <button class="btn ft-size-xsmall">
                미배송
              ...
              <li>
                ...
                <div class="d-flex-be-start">
                  ...
                  <p class="desc">
                    <span
                      v-show="!isPickup"
                      class="badge green mr-0"
                    >배송</span>
                    <span
                      v-show="isPickup"
                      class="badge yellow mr-0"
                    >집하</span>
                  </p>
                </div>
                <div class="d-flex-be-start">
                ...
                <div class="d-flex-be-start">
                  ...
                  <p class="desc">
                    배송지 근처 <span class="ft-weight-bold">0m</span>
                  </p>
                </div>
              </li>
              <li>
    ...
    <div class="l-drawer l-scroll l-delivery-complete">
      <el-drawer
        :visible.sync="drawerDeliveryComplete"
        direction="btt"
        size="92%"
        :with-header="false"
      >
...
export default {
  name: 'Delivery',
  components: {
    Gnb, FootMenu, PopWaybill, DeliveryComplete,
  },
  data() {
    return {
      activeNames: '',
